 ...
 */
function QuilljsImage(quill, options) {
    var DEFAULTS = {
        handler: '/',
 ...
 */
QuilljsImage.prototype.handleUploadComplete = function (filename, response) {
 ...
 * @private
 */
QuilljsImage.prototype.handleUploadFailed = function () {
 ...
 * @private
 */
QuilljsImage.prototype.initListeners = function () {
...
Quill.register('modules/image', QuilljsImage, true);
module.exports = QuilljsImage;
