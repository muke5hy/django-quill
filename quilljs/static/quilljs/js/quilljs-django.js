 ...
 */
function QuilljsDjango(id, editorSelector, toolbarSelector, imageModuleOpts, theme) {
    if(id === undefined) {
...
module.exports.QuilljsDjango = QuilljsDjango;
global.window.QuilljsDjango = QuilljsDjango;
